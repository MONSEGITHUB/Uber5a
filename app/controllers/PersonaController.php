...
require_once $_SERVER['DOCUMENT_ROOT'] . '/Uber5a/app/models/Persona.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/Uber5a/app/models/Sexo.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/Uber5a/app/models/Estadocivil.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/Uber5a/app/models/Direccion.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/Uber5a/app/models/Telefono.php';
