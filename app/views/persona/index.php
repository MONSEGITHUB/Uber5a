...
<div class="container">
    ...
    <a href="/Uber5a/public/persona/create"><button>Agregar</button></a>
                ...
                <?php foreach ($personas as $persona): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($persona['elsexo']); ?></td> <td><?php echo htmlspecialchars($persona['elestadocivil']); ?></td> <td>
                            <a href="/Uber5a/public/persona/view?idpersona=<?php echo htmlspecialchars($persona['idpersona']); ?>">
                                <button>View</button>
                            </a>
                            <a href="/Uber5a/public/persona/edit?idpersona=<?php echo htmlspecialchars($persona['idpersona']); ?>">
                                <button>Editar</button>
                            </a>
                            <a href="/Uber5a/public/persona/deleteForm?id=<?php echo htmlspecialchars($persona['idpersona']); ?>"
...
<script src="/Uber5a/public/js/script.js"></script>
</body>
</html>
